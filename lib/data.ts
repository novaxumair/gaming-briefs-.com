...
export const SITE = {
  name: "Cheats Intel",
  domain: "https://cheatsintel.com",
  domainHost: "cheatsintel.com",
  title: "Cheats Intel | Game Guides, Cheats & Tips",
  mainH1: "Cheats Intel",
  ...
  description:
    "Cheats Intel is your ultimate gaming article hub for game guides, updates, patch notes, and cheat feature breakdowns. Compare aimbot, ESP, wallhack, and spoofer options by title.",
  blogsTitle: "Informational Blogs | Cheats Intel",
  ...
  articlesTitle: "Cheat Guides | Cheats Intel",
  articlesMainH1: "Cheats Intel",
  ...
  articlesDescription:
    "Browse cheat guides by game with aimbot, ESP, wallhack, and spoofer feature lists, patch notes, and buyer FAQs on Cheats Intel.",
  contactTitle: "Contact | Cheats Intel Support",
  twitter: "@cheatsintel",
  themeColor: "#0a0f0a",
